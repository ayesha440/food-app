...
import 'package:food_app/all_categories/view/category_screens/all_indianfood.dart';
...
import '../../home_screen/view/category_page.dart';
import 'category_screens/all_burgers.dart';
import 'category_screens/all_grocery.dart';
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: (){
                      if(index == 0){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> AllBurgers()));
                      }
                      if(index == 1){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const AllGrocery()));
                      }
                      if(index == 2){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const AllSalad()));
                      }
                      if(index == 3){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const AllSweets()));
                      }
                      if(index == 4){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const All_Utensils()));
                      }
                      if(index == 5){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const AllIndianfood()));
                      }
                    },
                    child: Container(
                      // height: 103,
