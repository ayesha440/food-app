...
import 'package:food_app/cart_screen/view/cart_screen.dart';
...
class _Burger1State extends State<Burger1> {
  ...
  void _checkCartStatus() async {
    bool inCart = await CartManager.isItemInCart('Western BBQ');
    setState(() {
      isInCart = inCart;
    });
  }

  void _toggleCartItem() async {
    await CartManager.toggleCartItem('Western BBQ');
    _checkCartStatus();
  }
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/Hamburge_Double_Patty.png',
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(children: [
                              ...
                              isInCart?SizedBox(): Text("\$6.69", style: GoogleFonts.inter(fontWeight: FontWeight.w700,fontSize:14,color: Color(0xff28B996)),),
                            ],),
                          ),
                        ),
                      ),
