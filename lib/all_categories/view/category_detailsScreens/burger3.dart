...
class Burger3 extends StatefulWidget {
  const Burger3({super.key});

  @override
  State<Burger3> createState() => _Burger2State();
}

class _Burger2State extends State<Burger3> {
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/Grilled-chicken-burger.png',
