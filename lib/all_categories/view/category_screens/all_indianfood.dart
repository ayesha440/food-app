...
class AllIndianfood extends StatefulWidget {
  const AllIndianfood({super.key});

  @override
  State<AllIndianfood> createState() => _AllIndianfoodState();
}

class _AllIndianfoodState extends State<AllIndianfood> {
  final List<Product> _products = [
    Product(
      title: 'Laccha Paratha',
      imagePath: 'assets/2images/lachha_paratha.png',
      price: '\$30.59',
    ),
    Product(
      title: 'Pani Puri',
      imagePath: 'assets/2images/pani_puri.png',
      price: '\$33.90',
    ),
    Product(
      title: 'Indian Butter Chicken',
      imagePath: 'assets/2images/Indian-Butter-Chicken.png',
      price: '\$51.90',
    ),
    Product(
      title: 'Handy Murgh Curry',
      imagePath: 'assets/2images/handy_murgh_curry.png',
      price: '\$12.00',
    ),
