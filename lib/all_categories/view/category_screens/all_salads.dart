...
class AllSalad extends StatefulWidget {
  const AllSalad({super.key});

  @override
  State<AllSalad> createState() => _AllSaladState();
}

class _AllSaladState extends State<AllSalad> {
  final List<Product> _products = [
    Product(
      title: 'Avocada Salad',
      imagePath: 'assets/images/avocada_salad.png',
      price: '\$30.59',
    ),
    Product(
      title: 'Fruit Salad',
    ...
    Product(
      title: 'Greek kale Salad',
      imagePath: 'assets/images/greek_kale_salad.png',
      price: '\$51.90',
    ),
    Product(
      title: 'Beam Salad',
      imagePath: 'assets/images/beam_salad.png',
      price: '\$12.00',
    ),
