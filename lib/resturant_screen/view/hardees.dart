...
class Harveys extends StatelessWidget {
  const Harveys ({super.key});
          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("assets/images/3burger.png"),
                    fit: BoxFit.cover
                )
            ),
          ),
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: AssetImage("assets/images/hardeeslogo2.png"),
                  backgroundColor: Colors.black.withOpacity(0.1),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Hardees ",style: TextStyle(
